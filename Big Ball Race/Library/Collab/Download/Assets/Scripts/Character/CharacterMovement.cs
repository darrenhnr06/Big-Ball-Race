...
{   
    ...
    private void Movement()
    {
        ...
        if ( fixedJoystick.Horizontal != 0f || fixedJoystick.Vertical != 0f)
        {
            ...
            transform.rotation = Quaternion.Slerp(transform.rotation,Quaternion.LookRotation(rb.velocity), rotateSpeed * Time.deltaTime);
        }
        else
        {
              joystickClick = false;
    ...
    IEnumerator ThrowBall()
    {
        ...
        animator.SetBool("BallThrow_Start", false);
